        ...
        public static string conexion()
        {
            ...
            switch (number)
            {
                ...
                case 8: //CALZADOS JAGUAR
                    ...
                    break;
                case 9: //TELAS LIMA
                    strConexion = "Data Source=tcp:95.217.194.247,1433;Initial Catalog=telaslima_com_TL;Persist Security Info=True;User ID=telaslima_com_de;Password=rogola2012;MultipleActiveResultSets = True; TrustServerCertificate = False; Encrypt = False";

                    break;
                case 10: //ULIKE
                    strConexion = "Data Source=tcp:95.217.194.247,1433;Initial Catalog=telaslima_com_UL;Persist Security Info=True;User ID=telaslima_com_de;Password=rogola2012;MultipleActiveResultSets = True; TrustServerCertificate = False; Encrypt = False";
                    break;
