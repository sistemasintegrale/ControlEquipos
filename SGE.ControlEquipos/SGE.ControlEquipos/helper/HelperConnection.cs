        ...
        public static string conexion()
        {
            ...
            switch (number)
            {
                ...
                case 7: //CALZADOS JAGUAR
                    strConexion = "Data Source=tcp:95.217.194.247,1433;Initial Catalog=jaguar_com_pe_CJ;Persist Security Info=True;User ID=sistemasintegrales_com_CJ;Password=rogola2012;MultipleActiveResultSets = True; TrustServerCertificate = False; Encrypt = False";
                    break;
            }
            return strConexion;
        }
